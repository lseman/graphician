...
def built_in_patterns() -> list[FrameworkPattern]:
    ...
    return [
        ...
        FrameworkPattern(
            ...
            description="Detects configuration loading patterns (dotenv, pydantic-settings, etc.)",
            framework="generic",
            category=PatternCategory.GENERIC,
            required_node_kinds=[NodeKind.FUNCTION, NodeKind.CLASS],
            required_edge_kinds=[EdgeKind.DEFINES],
            signature_names=[
                "load_dotenv", "dotenv", "Settings", "BaseSettings",
                "pydantic_settings", "environ", "config",
                "configparser", "toml.load", "yaml.safe_load",
            ],
            import_patterns=["dotenv", "pydantic_settings", "configparser"],
            min_nodes=1,
            max_nodes=50,
        ),
    ]
